...
describe 'fmw_domain::extension_soa_suite', :type => :class do
  ...
  describe 'unix 1036' do
    ...
    describe "wls 11g" do
      ...
      it  { should contain_file('/tmp/soa_suite.py').with(
                      ensure:             'present',
                      mode:               '0755',
                      owner:              'oracle',
                      group:              'oinstall',
      ...
      it  { should contain_fmw_domain_wlst('WLST add soa_suite').with(
                      ensure:              'present',
                     ...
                     .that_requires("File[/tmp/soa_suite.py]")
      }
  ...
  describe 'unix cluster 1036' do
    ...
    describe "wls 11g" do
      ...
      it  { should contain_fmw_domain_wlst('WLST add soa_suite JMS cluster configuration').with(
                      ensure:              'present',
                      extension_check:     '<name>SOAJMSModuleUDDs</name>',
                      os_user:             'oracle',
                      script_file:         '/opt/oracle/middleware/Oracle_SOA1/bin/soa-createUDD.py --domain_home /opt/oracle/middleware/user_projects/domains/base_xxx --soacluster soa_cluster --create_jms true',
                      middleware_home_dir: '/opt/oracle/middleware',
                      weblogic_home_dir:   '/opt/oracle/middleware/wlserver_10.3',
                      java_home_dir:       '/usr/java/jdk1.7.0_75',
                      tmp_dir:             '/tmp',
                      domain_dir:          '/opt/oracle/middleware/user_projects/domains/base_xxx',
                    ).that_requires("Fmw_domain_wlst[WLST add soa_suite]")
                     .that_requires("File[/opt/oracle/middleware/user_projects/applications]")
                     .that_requires("File[/tmp/soa_suite.py]")
      }
  ...
  describe 'windows 1036' do
    ...
    describe "wls 11g" do
      ...
      it  { should contain_file('C:/temp/soa_suite.py').with(
                      ensure:             'present',
                    )
      }
      ...
      it  { should contain_fmw_domain_wlst('WLST add soa_suite').with(
                     ...
                     .that_requires("File[C:/temp/soa_suite.py]")
      }
